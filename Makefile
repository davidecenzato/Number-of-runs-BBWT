...
cais: main.cpp IOfunc.hpp BWTalgos.cpp external/malloc_count/malloc_count.o lib/cais32.o 
	$(CCX) $(CCX_FLAGS) -o $@ main.cpp IOfunc.hpp BWTalgos.cpp lib/cais32.o -lsdsl -ldivsufsort -ldivsufsort64

cais64: main.cpp IOfunc.hpp BWTalgos.cpp external/malloc_count/malloc_count.o lib/cais64.o 
	$(CCX) $(CCX_FLAGS) -o $@ main.cpp IOfunc.hpp BWTalgos.cpp lib/cais64.o -lsdsl -ldivsufsort -ldivsufsort64 -DM64
